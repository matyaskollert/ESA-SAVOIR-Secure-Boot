...
/* =========================================================================
 * Benchmark algorithm selection — mirrors benchmark.h ALGO_* constants.
 * BENCHMARK_ALGO is passed as a -D compiler flag or defined in benchmark.h.
 * Each section enables the wolfSSL primitives required by that algorithm.
 * ========================================================================= */

/* Mirror ALGO_* values so numeric -D flags can be compared below.
...
/* ------------------------------------------------------------------------- */
/* LMS  (ALGO_LMS = 7)                                                       */
/* Parameter set: LMS-SHA256-M32-H5 / LMOTS-N32-W8 (sig ≈ 1292 B).         */
