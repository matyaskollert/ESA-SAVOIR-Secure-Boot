 ...
 */
     ...
     */
		int (*generate_keys)(sig_ctx_t* ctx, const char* priv_path, const char* pub_path);
     ...
     * @return 0 on success, negative on failure.
     */
		int (*load_keys)(sig_ctx_t* ctx, const char* priv_path, const char* pub_path);
     ...
     * @return 0 on success, negative on failure.
     */
		int (*sign)(sig_ctx_t* ctx, const uint8_t* msg, size_t msg_len, uint8_t* sig_out,
		            size_t* sig_written);
     ...
     */
		int (*verify)(sig_ctx_t* ctx, const uint8_t* msg, size_t msg_len, const uint8_t* sig,
		              size_t sig_len);
	} sig_algo_t;
